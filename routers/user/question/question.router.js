...
import { schema } from "../../../validations/schema/user/question/question.schema.js";
import { type, validate, execute } from "../../../config/header_routers.js";
import { cache } from "../../../middlewares/cache.js";
import controller from "../../../controllers/user/question/question.controllers.js";
...
router.post(
    ...
    authentication,
    publicLimit,
    validate(schema.body.createQuestion, type.body),
...
router.put(
    ...
    authentication,
    publicLimit,
    validate(schema.body.updateQuestion, type.body),
